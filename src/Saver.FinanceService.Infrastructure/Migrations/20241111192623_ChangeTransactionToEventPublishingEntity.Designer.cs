...
namespace Saver.FinanceService.Infrastructure.Migrations
{
    ...
    [Migration("20241111192623_ChangeTransactionToEventPublishingEntity")]
    partial class ChangeTransactionToEventPublishingEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Saver.FinanceService.Domain.AccountHolderModel.BankAccount", b =>
                {
                    ...
                    b.HasOne("Saver.FinanceService.Domain.AccountHolderModel.Currency", "Currency")
                        .WithMany()
